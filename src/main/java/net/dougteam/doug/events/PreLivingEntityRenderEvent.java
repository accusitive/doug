...
public class PreLivingEntityRenderEvent<T extends LivingEntity> implements Event {
    ...
    public PreLivingEntityRenderEvent(T entity, float f, float g, MatrixStack matrices,
